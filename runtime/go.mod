...
require (
	...
	github.com/iotaledger/hive.go/constraints v0.0.0-20231212162051-0adc25efdfc0
	...
	github.com/iotaledger/hive.go/stringify v0.0.0-20231212162051-0adc25efdfc0
