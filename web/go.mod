...
require (
	github.com/iotaledger/hive.go/constraints v0.0.0-20231223025425-91257fbacf8b
...
require (
	...
	github.com/iotaledger/hive.go/serializer/v2 v2.0.0-rc.1.0.20231223025425-91257fbacf8b // indirect
