...
require (
	github.com/iotaledger/hive.go/ds v0.0.0-20230829151000-a4416d2e9c93
...
require (
	...
	github.com/iotaledger/hive.go/constraints v0.0.0-20230829151000-a4416d2e9c93 // indirect
