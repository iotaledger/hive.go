...
func (t *TestFramework) EvictIndex(index index.Index) {
...
func (m MockedEntityID) Index() index.Index {
	return m.index
}
...
func WithIndex(index index.Index) options.Option[MockedOrderedEntity] {
	return func(entity *MockedOrderedEntity) {
