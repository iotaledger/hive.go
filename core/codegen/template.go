...
// Parse parses the given file and extracts the Header and Content.
...
func (t *Template) Transcribe(fileName string, transcribeFunc ...func() (string, error)) error {
	generatedContent, err := lo.First(transcribeFunc, t.TranscribedContent)()
	if err != nil {
...
// TranscribedContent translates the tokens in the dynamic content to the mapped ones from the tokenMappings.
func (t *Template) TranscribedContent() (string, error) {
