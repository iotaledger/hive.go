...
var NewEvents = event.NewLinkableCollection(func(self *Events) (linker func(*Events)) {
...
var NewNestedEvents = event.NewLinkableCollection(func(self *NestedEvents) (linker func(*NestedEvents)) {
